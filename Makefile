...
# openshift.io/host-management-openstack-bundle:$VERSION and openshift.io/host-management-openstack-catalog:$VERSION.
IMAGE_TAG_BASE ?= openshift.io/host-management-openstack
...
IMG ?=  ghcr.io/osac-project/host-management-openstack:latest
